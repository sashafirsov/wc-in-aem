...
<!--
<load-paper-behaviors   disabled$="[[disabled]]" selection=[[zselection]] on-selection-changed='onCollectionChanged' class="load-collection" visible$="[[visible]]"></load-paper-behaviors>-->
<load-polymer-elements  disabled$="[[disabled]]" selection=[[zselection]] on-selection-changed='onCollectionChanged' class="load-collection" visible$="[[visible]]"></load-polymer-elements>
<load-paper-elements    disabled$="[[disabled]]" selection=[[zselection]] on-selection-changed='onCollectionChanged' class="load-collection" visible$="[[visible]]"></load-paper-elements>
<load-neon-animation    disabled$="[[disabled]]" selection=[[zselection]] on-selection-changed='onCollectionChanged' class="load-collection" visible$="[[visible]]"></load-neon-animation>
<load-iron-elements     disabled$="[[disabled]]" selection=[[zselection]] on-selection-changed='onCollectionChanged' class="load-collection" visible$="[[visible]]"></load-iron-elements>
<load-vaadin-elements   disabled$="[[disabled]]" selection=[[zselection]] on-selection-changed='onCollectionChanged' class="load-collection" visible$="[[visible]]"></load-vaadin-elements>
<load-mwc               disabled$="[[disabled]]" selection=[[zselection]] on-selection-changed='onCollectionChanged' class="load-collection" visible$="[[visible]]"></load-mwc>
<load-ionic             disabled$="[[disabled]]" selection=[[zselection]] on-selection-changed='onCollectionChanged' class="load-collection" visible$="[[visible]]"></load-ionic>
    `;
    }

    static get properties()
    {
        return  {   zselection: { type: String, value: "all", notify:true, reflectToAttribute:true }
